  ...
  return (
    <div className='featuredProducts'>
        <div className="top">
            <h1>{type} products</h1>
            <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis, nobis. Accusantium eos quibusdam dolor enim a 
                voluptatibus consequatur eum, soluta minus deleniti adipisci sapiente veritatis doloremque temporibus, deserunt impedit ducimus?
            </p>
        </div>
